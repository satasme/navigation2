                ...
                <View style={styles.header}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{flexDirection:"column",marginLeft:40,marginTop:10}}>
                            ...
                            <Text style={{color:'white'}}>Birth date :<Text style={{fontWeight:'bold',color:'black'}}> 2020-09-3 </Text></Text>
                            <Text style={{color:'white'}}>Birth weight: <Text style={{fontWeight:'bold',color:'black'}}> 5.0 </Text> Kg</Text>
                            <Text style={{color:'white'}}>Age: <Text style={{fontWeight:'bold',color:'black'}}> 1 </Text> year</Text>
                              <TouchableOpacity style={styles.button1} onPress={() => this.props.navigation.navigate('BMIMeter')}>
