...
import { Text, ScrollView, View, SafeAreaView, StyleSheet, TouchableOpacity, StatusBar, Alert, Dimensions, Image } from 'react-native';
        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={{ flex: 1, flexDirection: 'column' }}>
            ...
            <View style={styles.container}>
              ...
              <Card style={styles.card} >
                <TouchableOpacity onPress={() => this.props.navigation.navigate('WeightChart', {
                  data: ''
                })}>
                  <View style={{ alignItems: "center" }} >
                    <View style={{ height: 70, padding: 10 }}>
